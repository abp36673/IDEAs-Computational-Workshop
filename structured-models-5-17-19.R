...
plot(measles$Time, measles$Cases, type = 'l',xlab='Year',ylab='Cases')
...
##Exercise 1: Modify the WAIFW to reflect greater assortativity. 
#What effect does this have on the epidemioligal dynamics?

parms

parms<-list(beta=matrix(c(9.336, 2.089, 2.086, 2.037, 2.089, 9.336, 2.086, 2.037, 2.086, 2.086,
                          9.336, 2.037, 2.037, 2.037, 2.037,9.336),nrow=4,byrow=TRUE),
            sigma=1/8, gamma=1/5, nu=c(1/(55*365),0,0,0),  mu=c(1/(55*365),0,0,0))
parms

#When there is an increase in assortativity in mixing, the oscillations are dampened
  # sooner compared to the original matrices. With greater assortativity there 
  #is also a decrease in in proportion susceptible for all age groups, but with the 
  #greatest decrease in the age group of <5. 