...
##Exercise 1: Experiment with the initial number of infecteds (Y0) and with
  #the total population size (N). What effects do these have on the 
  #predictability of the epidemic? what effects do these have on the 
  #variability of the final outbreak size?

set.seed(38499583)                        #set the random seed so results are repeatable
nsims <- 10                               #number of simulations to run
pop.size <-100                           #total size of the population
Y0 <- 2                                  #initial number infected
nstep <- pop.size-Y0                      #how many steps to run? until everyone infected
xstart <- c(time=0,X=(pop.size-Y0),Y=Y0)  #initial conditions
params <- list(beta=0.3) #parameters
...
#if you keep the initial number of infected the same but decrease the 
  #population size the epidemic becomes more spaced out over time, meaning it is
  #less predictable. If you increase the number infected but maintain the 
  #population size the epidemic becomes more predictable. As you decrease 
  #population size the epidemic size has higher variability while increasing 
  #the population size the epidemic size is less variable. 
...
#Exercise 2: Experiment with the initial number of infected and the total 
  #population size. What effects do these have on the predictability
  #of the epidemic?
#if you increase the number of initially infected the epidemic ends sooner
  #meaning that majority of individuals are already infected earlier. 
  #and the epidemic is more predictable. 
#if you increase the population size the more unpredictable the epidemic
  #and the more time it will take for majority of individuals to 
  #become infected. 
#if you decrease the number of initially infected the epidemic is more 
  #unpredictable and the lonber it takes for the majority of 
